      ...
      <div class="header-glass-container">
        ...
        <nav class="desktop-nav" aria-label="Navigation principale">
          <ul class="nav-links">
            ...
            <li><a href="./apropos.php" class="nav-link" data-nav-key="about">A propos</a></li>
            <li><a href="./blog.php" class="nav-link" data-nav-key="blog">BLOG</a></li>
            <li><a href="./carrieres.php" class="nav-link" data-nav-key="careers">Carrieres</a></li>
    ...
    <div class="mobile-nav-overlay" aria-hidden="true">
      <nav class="mobile-nav-content" id="mobile-nav" aria-label="Navigation mobile">
        <ul>
          ...
          <li style="--delay: 0.3s"><a href="./apropos.php" class="mobile-link" data-nav-key="about">A propos</a></li>
          <li style="--delay: 0.4s"><a href="./blog.php" class="mobile-link" data-nav-key="blog">BLOG</a></li>
          <li style="--delay: 0.5s"><a href="./carrieres.php" class="mobile-link" data-nav-key="careers">Carrieres</a></li>
