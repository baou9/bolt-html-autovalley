...
<html lang="fr" class="no-js">
  <head>
    ...
    <title>Carrières – Rejoignez AutoValley | Casablanca</title>
    <meta name="description" content="Rejoignez l'équipe AutoValley, l'atelier automobile premium de Casablanca. Découvrez nos offres d'emploi et postulez en ligne." />
    ...
    <main id="main">
      ...
      <section class="pg-hero" id="carrieres-hero">
        <div class="pg-hero__bg" aria-hidden="true">
          <img
            src="https://images.pexels.com/photos/4489744/pexels-photo-4489744.jpeg?auto=compress&cs=tinysrgb&w=1920"
            alt=""
